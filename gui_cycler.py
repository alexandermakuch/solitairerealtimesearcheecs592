...
"""
just replace all of the items with what you want them to be, copy and pasted from extracting them from the state. then do this as many times as you want and append it to stateList, four random examples shown below
tableau = [..................]
foundation = [..........]
stock = [........]
lens= np.array([3,3,3,3,3,3,3,3])
unreachable_talon = deque([...........................])
...
class GUIstate:
    def __init__(self, new_reachable_talon, new_unreachable_talon, new_foundation, new_tableau):
        self.new_reachable_talon = new_reachable_talon
        self.new_unreachable_talon = new_unreachable_talon
        self.new_foundation = new_foundation
        self.new_tableau = new_tableau
